    ...
    const formSubmit = (e) =>{
        ...
        if (validateForm())
        {
            ...
            var entry = {
                ...
                "custom_feedback": customFeedback, // Include custom feedback in the entry
            };
                        ...
                        <Row>
                                <Col>
                                    <Form.Group className="details" controlId="customFeedback">
                                        ...
                                        <Form.Control as="textarea" rows={3} placeholder="Enter your custom feedback" value={customFeedback} onChange={handleCustomFeedbackChange} />
                                    </Form.Group>
                                </Col>
                            </Row>
